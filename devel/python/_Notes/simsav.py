...
"""Simulate Savage World style exploding dice.

$ montage -tile 2x0 -geometry -70-30 -border 0 1d4_1000000.png 1d6_1000000.png 1d8_1000000.png 1d10_1000000.png 1d12_1000000.png out.png
...
if __name__ == "__main__":
    ...
    if any(x in args for x in ["-h", "--help", "-?"]) or len(args)<2: 
