...
git clone 'git@github.com:peel/dotfiles/tree/master/nix/.config/nixpkgs.git' 'peel_dotfiles_tree_master_nix'
...
git clone 'git@github.com:adisbladis/nixconfig.git' 'adam_hose-adisbladis'
