    ...
    nix = {
      ...
      settings = {
        ...
        builders = lib.mkDefault ( builtins.concatStringsSep ";" [
          "ssh://nixbuilder@10.17.6.60 x86_64-linux /root/.ssh/id_rsa 4 10 big-parallel,kvm,nixos-test,benchmark - c3NoLWVkMjU1MTkgQUFBQUMzTnphQzFsWkRJMU5URTVBQUFBSUNIMk1WSHUrV1lOeHpsWUFJMXRWdzd3OWhjNHRSbXhyY2xZbjc0ZUlheW8="
